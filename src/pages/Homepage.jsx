...
const PLACEHOLDER_RECENSIONI = [
  {
    ...
    stelle: 5,
    testo:
      "Un posto magico. La struttura è bellissima, la colazione straordinaria con prodotti locali freschi. Torneremo sicuramente.",
  },
  {
    id: 2,
    nome: "Sophie",
    ...
    stelle: 5,
    testo:
      "L'accueil est exceptionnel. Un endroit magnifique au cœur des Pouilles. Les propriétaires sont adorables et pleins de bons conseils.",
  },
  {
    id: 3,
    nome: "Thomas & Anna",
    ...
    stelle: 5,
    testo:
      "Perfekte Lage, wunderschönes Anwesen. Das Frühstück war ein Traum. Wir kommen wieder!",
  },
];
...
export default function Homepage() {
  ...
  const recensioni =
    recensioniWP?.length > 0 ? recensioniWP : PLACEHOLDER_RECENSIONI;
        ...
        <div className="container">
          ...
          <div className="row justify-content-center g-3">
            {(Array.isArray(servizi) ? servizi : []).map((s, i) => {
              const label =
                typeof s === "string" ? s : s.servizio || s.label || "";
              return (
                <div
                  className="col-6 col-md-4 col-lg-3 fade-in"
                  key={i}
              ...
              >
                <div className="card-bnb h-100">
                  ...
                  <div className="p-4">
                    ...
                    <div
                      className="d-flex gap-3 text-muted mt-2"
