...
export const metadata = {
  ...
  keywords: [
    ...
    "dimora antica salento",
    "b&b corigliano otranto",
    "casa vacanze sternatia",
    "affitto salento",
    "b&b puglia",
  ],
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Un'antica dimora pugliese tra Corigliano d'Otranto e Sternatia. B&B con spa e casa intera nel cuore del Salento.",
    images: [
      {
        url: "/IMG_5289.JPEG",
        width: 1200,
        height: 800,
        alt: "Le Mura degli Angeli — Dimora Storica nel Salento",
      },
    ],
  },
};
...
const schemaLodging = {
  ...
  description:
    "Antica dimora nel Salento con B&B a Corigliano d'Otranto e casa vacanze a Sternatia. Ospitalità autentica nella Grecìa Salentina.",
  ...
  return [
    {
      ...
      tipo: "Due Camere",
      image:
        apiData.corigliano?.rooms?.[0]?.featured_image || PLACEHOLDER[0].image,
    },
    {
      slug: "sternatia",
      nome: apiData.sternatia?.title || "Sternatia",
      tipo: "Casa Intera",
      image: apiData.sternatia?.featured_image || PLACEHOLDER[1].image,
    },
  ];
}
          ...
          <div className="row">
            <div className="col-lg-8 fade-in">
              ...
              <div className="d-flex gap-3 flex-wrap">
                ...
                />
                <Link href="/strutture" className="btn-bnb btn-bnb-white">
                  Scopri le strutture
                </Link>
              </div>
            </div>
        ...
        <div className="container">
          <div className="row align-items-center g-5">
            <div className="col-lg-6 fade-in">
              <img
                src="/2.jpg"
                alt="Dimora storica Le Mura degli Angeli nel Salento"
          ...
          <div className="row g-4">
            {strutture.map((s) => (
              <div className="col-12 col-md-6" key={s.slug}>
                <Link
                  href={`/strutture/${s.slug}`}
                  className="text-decoration-none"
                >
                  <div className="fade-in" style={{ overflow: "hidden" }}>
                    <img
                      src={s.image}
                      alt={`${s.nome} — ${s.tipo} nel Salento`}
                      className="img-bnb w-100"
            ...
            <div className="col-lg-7 fade-in">
              ...
              <div className="d-flex gap-3 justify-content-center flex-wrap">
                <BookingButtonWithModal
                  ...
                  className="btn-bnb btn-bnb-accent"
                />
                <Link href="/contatti" className="btn-bnb btn-bnb-white">
