...
export const metadata = {
  ...
  openGraph: {
    title: 'Cosa fare nel Salento | Le Mura degli Angeli B&B',
    description: 'Guida alle esperienze nel Salento: cultura, mare, enogastronomia e natura a pochi minuti dal nostro B&B.',
  },
};

const PLACEHOLDER = [
  { id: 1, title: 'Centro storico di Lecce', tipologia: 'Cultura', distanza: '15 min', featuredImage: { url: 'https://images.unsplash.com/photo-1592482571769-2189eee1d7fc?w=600&q=80', alt: 'Lecce barocca' }, excerpt: '<p>La "Firenze del Sud" con il suo barocco leccese, le chiese, i palazzi storici e l\'anfiteatro romano.</p>' },
  { id: 2, title: 'Spiagge di Porto Cesareo', tipologia: 'Mare', distanza: '30 min', featuredImage: { url: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&q=80', alt: 'Mare Salento' }, excerpt: '<p>Acque cristalline e spiagge caraibiche. Le Maldive del Salento sono a pochi chilometri.</p>' },
  ...
  { id: 4, title: 'Frantoi ipogei e degustazioni', tipologia: 'Enogastronomia', distanza: '10 min', featuredImage: { url: 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=600&q=80', alt: 'Ulivi Salento' }, excerpt: '<p>Visita i frantoi sotterranei e degusta l\'olio extravergine d\'oliva salentino direttamente dai produttori.</p>' },
...
export default async function Esperienze() {
  const esperienzeWP = await getEsperienze();
      ...
      <section className="section-padding pb-0">
        <div className="container text-center fade-in">
          ...
          <p style={{ maxWidth: 650, margin: '0 auto' }}>
            Dal barocco di Lecce alle spiagge cristalline, dai frantoi ipogei alla cucina locale: il Salento offre esperienze per ogni tipo di viaggiatore.
          </p>
        </div>
      </section>
                ...
                <div className="card-bnb h-100">
                  ...
                  <div className="p-4">
                    <div className="d-flex justify-content-between align-items-center mb-2">
                      ...
                      {exp.distanza && <small className="text-muted">{exp.distanza}</small>}
                    </div>
                    <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.2rem' }} dangerouslySetInnerHTML={{ __html: exp.title }} />
