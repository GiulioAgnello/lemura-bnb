  ...
  return (
    <>
      <button
        ...
        style={{
          position: 'fixed', bottom: '3rem', right: '2rem', zIndex: 1050,
          background: 'var(--color-accent)', color: '#fff', border: 'none',
          borderRadius: '50px', padding: '0.85rem 1.6rem', fontSize: '1.25rem',
          fontWeight: 600, letterSpacing: '0.04em', cursor: 'pointer',
          boxShadow: '0 4px 20px rgba(0,0,0,0.25)', transition: 'transform 0.15s, box-shadow 0.15s',
        }}
        onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 6px 24px rgba(0,0,0,0.30)'; }}
